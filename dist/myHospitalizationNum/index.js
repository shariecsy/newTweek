...
var Root = React.createClass({
	...
	_addHospitalizationNum: function _addHospitalizationNum() {
		window.location = "../addHospitalizationNum/index.html";
	},
	render: function render() {
		return React.createElement(
			'div',
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'button',
							{ className: 'am-btn am-btn-block am-btn-primary am-round', onClick: this._addHospitalizationNum },
							'\u5173\u8054\u66F4\u591A'
						)
					)
				)
