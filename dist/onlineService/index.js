...
var Root = React.createClass({
    ...
    _getGoods: function _getGoods(pages) {
        ...
        UAjax.ajax({
            ...
            method: 'post',
            url: 'http://localhost:8080/v1.0/medicinal/list',
            data: {
                page: page
            },
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    Header.LeftItem,
                    null,
                    React.createElement('a', { href: 'javascript:window.history.back()', className: 'am-icon-angle-left header-left-icon' })
                ),
                React.createElement(
                    Header.CenterItem,
                    null,
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement('i', { className: 'am-icon-home header-right-icon' })
                    )
                )
            ),
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        this.state.goodsList.map(function (v, i) {
                            return React.createElement(
                                'div',
                                { className: 'goods-list-item', key: i },
                                React.createElement(
                                    'div',
                                    { className: 'goods-list-item-img' },
                                    React.createElement('img', { src: v.img_url })
                                ),
                                React.createElement(
                                    'div',
