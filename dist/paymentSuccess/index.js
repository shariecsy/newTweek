		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					...
					React.createElement('span', { className: 'am-icon-check-circle result-icon result-icon-success' }),
					React.createElement(
						'p',
				...
				React.createElement(
					...
					React.createElement(
						'a',
						{ href: "../checkOrderDetail/index.html?id=" + id, className: 'show-order-btn fl' },
						'\u67E5\u770B\u8BA2\u5355'
					),
					React.createElement(
						'a',
						{ href: '../index/index.html', className: 'back-to-index-btn fr' },
						'\u8FD4\u56DE\u9996\u9875'
					)
				)
			)
