...
var css_config = {
    entry: {
        'app.css': './dist/libs/assets/scss/app.scss',
        'elink.css': './dist/libs/assets/scss/elink.scss',
        'my.css': './dist/libs/assets/scss/my.scss',
        'search.css': './dist/libs/assets/scss/search.scss',
        'sharie.css': './dist/libs/assets/scss/sharie.scss',
        'eShop.css': './dist/libs/assets/scss/eShop.scss'
    },
    output: {
        path: path.resolve(__dirname, 'dist/libs/assets/css'),
        filename: "[name]"
    },
    plugins: [
        // 构建优化插件
